...
import 'package:yemekler_uygulamasi/utils/constants.dart';
...
class _LoginContentState extends State<LoginContent>
    ...
    return Padding(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          ...
          backgroundColor: ColorsFor.kSecondaryColor,
      ...
      child: TextButton(
        ...
        child: const Text(
          ...
          style: TextStyle(
            fontSize: 16,
            fontWeight: FontWeight.w600,
            color: ColorsFor.kSecondaryColor,
          ),
        ),
      ),
    );
  ...
  void initState() {
    createAccountContent = [
      ...
      inputField(_tPassword, 'Şifre', Icons.lock_clock_outlined),
      actionButton(
        'Kayıt Ol',
